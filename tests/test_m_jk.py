...
def test_tree_version(IA_mock_TNG300_jk):
	IA_mock_TNG300_jk.measure_xi_multipoles_jk("All_tree", 'both', 8, file_tree_path='./data/processed/')
	output_wgp = ReadData("TNG300", "test_IA_mock_TNG300_jk", 99, "multipoles_g_plus/",
						  data_path='./data/processed/TNG300/')
	output_wgg = ReadData("TNG300", "test_IA_mock_TNG300_jk", 99, "multipoles_gg/",
						  data_path='./data/processed/TNG300/')
	wgp = output_wgp.read_cat("All_tree")
	rp_wgp = output_wgp.read_cat("All_tree_r")
	cov_wgp = output_wgp.read_cat("All_tree_jackknife_cov_8")
	wgg = output_wgg.read_cat("All_tree")
	rp_wgg = output_wgg.read_cat("All_tree_r")
...
def test_multiproc_version(IA_mock_TNG300_jk_n8):
	IA_mock_TNG300_jk_n8.measure_xi_multipoles_jk("All_multiproc", 'both', 8, file_tree_path='./data/processed/')
	output_wgp = ReadData("TNG300", "test_IA_mock_TNG300_jk", 99, "multipoles_g_plus/",
						  data_path='./data/processed/TNG300/')
	output_wgg = ReadData("TNG300", "test_IA_mock_TNG300_jk", 99, "multipoles_gg/",
						  data_path='./data/processed/TNG300/')
	wgp = output_wgp.read_cat("All_multiproc")
	rp_wgp = output_wgp.read_cat("All_multiproc_r")
	cov_wgp = output_wgp.read_cat("All_multiproc_jackknife_cov_8")
	wgg = output_wgg.read_cat("All_multiproc")
	rp_wgg = output_wgg.read_cat("All_multiproc_r")
